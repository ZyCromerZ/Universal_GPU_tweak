...
runScript(){
    ...
    if [ "$FromTerminal" == "tidak" ];then
        ...
        if [ "$GMSDoze" == "1" ];then
            ...
            if [ "$GetBusyBox" == "none " ];then
                echo "GMS Doze fail . . ." | tee -a $Path/ZyC_GmsDoze.log 2>&1 1>/dev/null 2>/dev/null
            else
                echo "Note : better to use universal gms doze :D" | tee -a $Path/ZyC_GmsDoze.log 2>&1 1>/dev/null 2>/dev/null
                changeSE="tidak"
                if [ "$(getenforce)" == "Enforcing" ];then
                    changeSE="ya"
                    setenforce 0
                fi
                pm disable com.google.android.gms/com.google.android.gms.mdm.receivers.MdmDeviceAdminReceiver | tee -a $Path/ZyC_GmsDoze.log 2>&1 1>/dev/null 2>/dev/null
                pm disable com.google.android.gms/com.google.android.gms.auth.managed.admin.DeviceAdminReceiver | tee -a $Path/ZyC_GmsDoze.log 2>&1 1>/dev/null 2>/dev/null
                if  [ ! -z "$(pm list packages -f com.google.android.gms)" ] ; then
                    su -c "pm enable com.google.android.gms/.ads.social.GcmSchedulerWakeupService"  | tee -a $Path/ZyC_GmsDoze.log 2>&1 1>/dev/null 2>/dev/null
                    su -c "pm enable com.google.android.gms/.analytics.AnalyticsService"  | tee -a $Path/ZyC_GmsDoze.log 2>&1 1>/dev/null 2>/dev/null
                    su -c "pm enable com.google.android.gms/.analytics.service.PlayLogMonitorIntervalService"  | tee -a $Path/ZyC_GmsDoze.log 2>&1 1>/dev/null 2>/dev/null
                    su -c "pm enable com.google.android.gms/.update.SystemUpdateService"  | tee -a $Path/ZyC_GmsDoze.log 2>&1 1>/dev/null 2>/dev/null
                    su -c "pm enable com.google.android.gms/.update.SystemUpdateService\$ActiveReceiver"  | tee -a $Path/ZyC_GmsDoze.log 2>&1 1>/dev/null 2>/dev/null
                    su -c "pm enable com.google.android.gms/.update.SystemUpdateService\$Receiver"  | tee -a $Path/ZyC_GmsDoze.log 2>&1 1>/dev/null 2>/dev/null
                    su -c "pm enable com.google.android.gms/.update.SystemUpdateService\$SecretCodeReceiver"  | tee -a $Path/ZyC_GmsDoze.log 2>&1 1>/dev/null 2>/dev/null
                    su -c "pm enable com.google.android.gms/.update.SystemUpdateActivity"  | tee -a $Path/ZyC_GmsDoze.log 2>&1 1>/dev/null 2>/dev/null
                fi
                if  [ ! -z "$(pm list packages -f com.google.android.gsf)" ] ; then
                    su -c "pm enable com.google.android.gsf/.update.SystemUpdatePanoActivity" | tee -a $Path/ZyC_GmsDoze.log 2>&1 1>/dev/null 2>/dev/null
                    su -c "pm enable com.google.android.gsf/.update.SystemUpdateService" | tee -a $Path/ZyC_GmsDoze.log 2>&1 1>/dev/null 2>/dev/null
                    su -c "pm enable com.google.android.gsf/.update.SystemUpdateService\$Receiver" | tee -a $Path/ZyC_GmsDoze.log 2>&1 1>/dev/null 2>/dev/null
                    su -c "pm enable com.google.android.gsf/.update.SystemUpdateService\$SecretCodeReceiver" | tee -a $Path/ZyC_GmsDoze.log 2>&1 1>/dev/null 2>/dev/null
                    su -c "pm enable com.google.android.gsf/.update.SystemUpdateActivity" | tee -a $Path/ZyC_GmsDoze.log 2>&1 1>/dev/null 2>/dev/null
                fi
                if [ "$changeSE" == "ya" ];then
                    setenforce 1
                fi
                ...
                echo "GMS Doze done . . ." | tee -a $Path/ZyC_GmsDoze.log 2>&1 1>/dev/null 2>/dev/null
            fi
        else
...
if [ "$FromTerminal" == "tidak" ];then
    if [ -e "/system/etc/ZyC_Ai/ai_mode.sh" ];then
        ...
        if [ -e "$PathModulConfigAi/ai_status.txt" ]; then
            ...
            if [ "$AiStatus" == "1" ];then
                echo "starting ai mode . . . " | tee -a $saveLog 2>&1 1>/dev/null 2>/dev/null
                echo "  --- --- --- --- --- " | tee -a $saveLog 2>&1 1>/dev/null 2>/dev/null
            elif [ "$AiStatus" == "2" ];then
                echo "re - run ai mode . . . " | tee -a $saveLog 2>&1 1>/dev/null 2>/dev/null
                echo "  --- --- --- --- --- " | tee -a $saveLog 2>&1 1>/dev/null 2>/dev/null
            elif [ "$AiStatus" == "3" ];then
                echo "deactive ai mode . . . " | tee -a $saveLog 2>&1 1>/dev/null 2>/dev/null
                echo "  --- --- --- --- --- " | tee -a $saveLog 2>&1 1>/dev/null 2>/dev/null
            elif [ "$AiStatus" == "0" ];then
                echo "ai status off"| tee -a $saveLog 2>&1 1>/dev/null 2>/dev/null
                echo "  --- --- --- --- --- " | tee -a $saveLog 2>&1 1>/dev/null 2>/dev/null
            else
                echo "ai status error,set to 0"| tee -a $saveLog 2>&1 1>/dev/null 2>/dev/null
...
echo "finished at $(date +"%d-%m-%Y %r")"| tee -a $saveLog 2>&1 1>/dev/null 2>/dev/null
echo "  --- --- --- --- --->> " | tee -a $saveLog 2>&1 1>/dev/null 2>/dev/null
exit 0
